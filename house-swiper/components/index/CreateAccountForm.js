...
export default function CreateAccountForm() {
  ...
  async function createAccountHandler(event) {
    ...
    try {
      ...
      if (response.ok) {
        swal(
          "you have successfully created a house swiper account !\n\rkindly log in using your credentials"
        );
      }
    } catch (error) {
      console.error(error);
  ...
  return (
    <div className={styles.container}>
      <form onSubmit={createAccountHandler}>
        ...
        <div className={styles.inputWrapper}>
          <label>What brings you here :D </label>
          <br></br>
          <select
            name="reason"
            id="reason"
            value={inputValues.lookingFor}
            onChange={(e) =>
              setInputValues({ ...inputValues, lookingFor: e.target.value })
            }
            required
          >
            <option>Select an option</option>
            <option value="accommodation">
              I am looking for a house or room
            </option>
            <option value="leasing">
              I have a house or room I want to rent
            </option>
          </select>
        </div>
        <div className={styles.inputWrapper}>
        ...
        <div className={styles.inputWrapper}>
          ...
          <select
            ...
            onChange={(e) =>
              setInputValues({ ...inputValues, occupation: e.target.value })
            }
            required
          >
            <option>Select an option</option>
